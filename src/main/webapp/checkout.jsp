...
<div class="container-fluid py-5">
    <div class="container py-5">
        ...
        <form action="${pageContext.request.contextPath}/buy-products" method="post">
            <div class="row g-5">
                <div class="col-md-12 col-lg-6 col-xl-7">
                    <div class="form-item">
                        <label class="form-label my-3">Address <sup>*</sup></label>
                        <input name="dia_chi_nhan_hang" type="text" class="form-control" placeholder="House Number Street Name" required>
                    </div>
                    <div class="form-item">
                    ...
                    <div class="form-item">
                        ...
                        <textarea name="mo_ta"  type="text" class="form-control" spellcheck="false" cols="30" rows="11" placeholder="Oreder Notes (Optional)"></textarea>
                    </div>
                </div>
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tr>
                                <th scope="row">
                                    <div class="d-flex align-items-center mt-2">
                                        <img src="<%=product.getHinh_anh_san_pham()%>" class="img-fluid rounded-circle" style="width: 90px; height: 90px;" alt="<%=product.getTen_san_pham()%>">
                                    </div>
                                </th>
                                <td class="py-5"><%=product.getTen_san_pham()%></td>
                                <td class="py-5"><%=product.getGia_san_pham()%></td>
                                <td class="py-5"><%=product.getSo_luong_san_pham()%></td>
                                <td class="py-5"><%=String.format("%.2f", product.getGia_san_pham() * Integer.parseInt(product.getSo_luong_san_pham()))%></td>
                            </tr>
                            <% }
                                }else {
                            ...
                            <% } %>
                                ...
                                <td class="text-end" ><%=String.format("%.2f", products.stream().mapToDouble(p -> p.getGia_san_pham() * Integer.parseInt(p.getSo_luong_san_pham())).sum())%>$</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="text-end"><%=String.format("%.2f", products.stream().mapToDouble(p -> p.getGia_san_pham() * Integer.parseInt(p.getSo_luong_san_pham())).sum() + 3)%>$</td>
                            </tr>
                            </tbody>
                        </table>
                    </div>

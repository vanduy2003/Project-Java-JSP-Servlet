...
public class User {
    ...
    public User(int id, String ho_dem, String ho_va_ten, String ten, String so_dien_thoai, Date ngay_sinh, float chi_tieu, String mat_khau, String email, String dia_chi, String vai_tro) {
        this.id = id;
        this.ho_dem = ho_dem;
